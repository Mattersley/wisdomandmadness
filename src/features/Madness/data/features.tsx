const features = [
  ...
  },
  {
    ...
    blurb:
      '64% of internet traffic comes from mobile devices. We always start our development by building the mobile version, then we build out the desktop version. No more text and images cut off the screen - your customers will see 100% of the information.',
    icon: (
      <>
  ...
  },
  {
    ...
    blurb:
      'We ensure that our products are accessible to inclusive of everyone. We make sure that we adhere to WCAG at the very minimum.',
    icon: (
      <>
  ...
  },
  {
    caption: 'Score-Aware',
    blurb:
      'We ensure that anything we build for you continuously maintains high scores in PageSpeed Insights, Lighthouse, and Core Web Vitals',
    icon: (
      <>
  ...
  },
  {
    ...
    blurb:
      'We are always ready to listen and solve any issues you have. On our monthly plans, we are here for you 24/7',
    icon: (
      <>
  ...
  },
  {
    caption: 'Canadian',
    blurb:
      'Proudly registered and operating in Victoria, British Columbia, Canada',
    icon: (
      <>
  ...
  },
  {
    ...
    blurb:
      'We build web experiences for all sectors, however we have a wealth of experience and knowledge in the food and beverage industry.',
    icon: (
      <>
  ...
  },
  {
    caption: 'Anti-SLOP',
    blurb:
      'Our designs are never created by AI. Our dev team has years of development experience prior to the robot uprising. Our values are to reduce the amount of electricity and server time used. AI data centers’ consumption of electricity and water is currently massively environmentally significant.',
    icon: (
      <>
  ...
  },
  {
    ...
    blurb:
      'We are a dog-friendly company. We have a dog named Bao who is always happy to help you with any questions you may have.',
    icon: (
      <>
        <path d="M11 5h2"></path>
  ...
  },
  {
    ...
    blurb:
      'On top of ensuring our products are accessible, we ensure that our designs are ethical, sustainable, and your privacy and data protection is a key tenet. We are always transparent with any questions you may have about our practises.',
    icon: (
      <>
  ...
  },
  {
    ...
    blurb:
      'Our goal is to produce sustainable digital products that optimise server usage, have low data loads, minimise use of non-renewable resources, and are built to last with minimal external packages.',
    icon: (
      <>
  ...
  },
  {
    caption: 'Local-First',
    blurb:
      'Wherever possible we aim to reduce use of large corporations and opt for local businesses and services. We are always looking for ways to improve our local-first culture and are always open to new ideas and opportunities.',
    icon: (
      <>
  ...
  },
  {
    ...
    blurb:
      'We are a cat-friendly company. Our cat is not happy and will not help you with any questions you may have.',
    icon: (
      <>
