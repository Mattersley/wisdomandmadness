...
const Portfolio = () => {
  ...
  return (
      <div
        className={
          'no-scrollbar -mb-7 flex h-auto min-h-[1300px] w-screen snap-mandatory snap-center flex-col items-center justify-start rounded-b-4xl bg-white px-10 py-20 shadow-xl sm:px-10 md:px-30 md:pt-50'
        }
        id="work"
      >
