...
const About = () => {
  return (
    <div
      className="relative -mt-7 flex w-screen flex-col items-center rounded-t-4xl bg-neutral-950 py-20 text-white drop-shadow-2xl select-none"
      id="about"
    >
      ...
      <h2
        className={
          'font-vagra bg-linear-to-tr from-[#3F5EFB] to-[#FC466B] bg-clip-text text-[4rem] text-transparent sm:text-[5rem] xl:text-[7rem]'
        }
      >
        About
      </h2>
