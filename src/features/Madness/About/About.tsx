...
const About = () => {
  return (
    ...
    >
      <h2
        className={'font-vagra bg-linear-to-tr from-[#3F5EFB] to-[#FC466B] bg-clip-text text-[7rem] text-transparent'}
      >
        About
      </h2>
      <motion.p
      ...
      <div className="mr-60 mb-10 flex flex-col items-center text-center md:grid md:w-240 md:grid-cols-2 md:flex-row md:items-start md:gap-5 md:text-right lg:w-[90%]">
        <ProfileCard />
        <p className="mb-4 w-[90%] self-center text-white/80 sm:w-[60%] md:ml-6 md:text-left">
