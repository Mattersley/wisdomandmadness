  ...
  return (
    ...
    >
      ...
      <a href="mailto:matt@wisdomandmadness.com">
        <div className="flex flex-row items-center text-xs text-rose-500 opacity-40 transition-opacity hover:opacity-100 md:justify-end">
          <svg
            fill="none"
            height="24"
            stroke="currentColor"
...
const About = () => {
  return (
    <div className="relative flex w-screen flex-col items-center bg-neutral-950 py-20 text-white select-none" id="about">
      <h2
        className={`${vagraFont.className} bg-linear-to-tr from-[#3F5EFB] to-[#FC466B] bg-clip-text text-[6rem] text-transparent`}
      >
        About
      </h2>
