...
const CaseStudyHeader = ({
  ...
  return (
    <div
      className={`flex h-auto w-full flex-row items-center rounded-b-3xl bg-gradient-to-r from-[${bgColours['1']}]/20 to-[${bgColours['2']}]/20`}
    >
      <button
        className={`flex h-full cursor-pointer items-center stroke-black hover:stroke-white sm:mr-6 sm:p-4 hover:bg-[${bgColours['1']}] rounded-bl-3xl`}
      >
        <svg
          fill="none"
          height="32"
      ...
      <div className="my-10 flex w-full flex-col items-center justify-between sm:p-3 md:my-2 md:flex-row md:gap-6">
        ...
        <div className="relative mb-6 px-4 md:px-0 sm:px-0 md:mb-0">
          <Image
            alt={image.alt}
            height={image.height}
            src={image.src}
      ...
      <button
        className={`flex h-full cursor-pointer items-center stroke-black hover:stroke-white sm:ml-6 sm:p-4 hover:bg-[${bgColours['2']}] rounded-br-3xl`}
      >
        <svg
          fill="none"
          height="32"
