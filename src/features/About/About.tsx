    ...
    return (
        <div className="relative mb-4 border-white/40 py-4 pr-5 md:border-r">
            ...
            <a href="mailto:matt@wisdomandmadness.com">
                <div
                    className="flex flex-row items-center justify-end text-xs text-rose-500 opacity-40 hover:opacity-100 transition-opacity">
                    <svg
                        fill="none"
                        height="24"
                        stroke="currentColor"
                    ...
                    <p className="ml-2">matt@wisdomandmadness.com</p>
                </div>
            </a>
    ...
    return (
        ...
        >
            ...
            <motion.div variants={contentVariants}>
                <span aria-label="Noodles" className="text-3xl" role="img">🍜</span>
            ...
            <motion.div variants={contentVariants}>
                <span aria-label="Videocassette" className="text-3xl" role="img">📼</span>
                <p className="font-bold">
            ...
            <motion.div variants={contentVariants}>
                <span aria-label="Speaker" className="text-3xl" role="img">🔊</span>
                <p className="font-bold">
...
const About = () => {
    return (
        <div
            className="relative flex w-screen snap-mandatory snap-start flex-col items-center bg-neutral-950 py-20 text-white select-none">
            <h2
            ...
            <div
                className="mb-10 flex flex-col items-center text-center md:grid md:w-[60rem] md:grid-cols-2 md:flex-row md:items-start md:gap-5 md:text-right lg:w-[90%]">
                <ProfileCard/>
