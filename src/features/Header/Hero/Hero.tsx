...
const Hero = () => {
  return (
    <div className="relative flex size-full md:-mb-24 z-10">
      <div className="w-full flex-row md:px-20">
        <Nav />
        <ThreeD />
        <div className="relative flex h-[95%] w-full flex-col md:gap-x-6">
          <div className="relative -mb-12 mx-auto min-h-[120vh] w-[98%] rounded-3xl bg-white sm:mt-4 sm:min-h-[90vh] md:z-[1] md:-mt-14 md:min-h-[95vh] md:w-full">
            {/*Header Buttons BG*/}
